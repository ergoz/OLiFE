...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sun Oct 16 15:22:48 2011
# Project:  OLiFE.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/OLiFE1.0.0/ && $(COPY_FILE) --parents src/mainwindowimpl.h src/nvsupport.h src/downloader.h src/nvhash.h src/defines.h src/file.h build/OLiFE1.0.0/ && $(COPY_FILE) --parents src/mainwindowimpl.cpp src/main.cpp build/OLiFE1.0.0/ && $(COPY_FILE) --parents ui/mainwindow.ui build/OLiFE1.0.0/ && (cd `dirname build/OLiFE1.0.0` && $(TAR) OLiFE1.0.0.tar OLiFE1.0.0 && $(COMPRESS) OLiFE1.0.0.tar) && $(MOVE) `dirname build/OLiFE1.0.0`/OLiFE1.0.0.tar.gz . && $(DEL_FILE) -r build/OLiFE1.0.0
